...
0	3.869182	-0.719582
    ...
    public static class ScoringLocations{
        public static Pose2d topRightReefEdge = new Pose2d(-4.7,-0.719582,Rotation2d.fromDegrees(60));
        public static Pose2d topReefEdge = new Pose2d(-5.11,0,Rotation2d.fromDegrees(0));
        public static Pose2d topLeftReefEdge = new Pose2d(-4.7,0.719582,Rotation2d.fromDegrees(300));
        public static Pose2d bottomLeftReefEdge = new Pose2d(-3.87,0.719582,Rotation2d.fromDegrees(240));
        public static Pose2d bottomReefEdge = new Pose2d(-3.45,0,Rotation2d.fromDegrees(180));
        public static Pose2d bottomRightReefEdge = new Pose2d(-3.87,-0.719582,Rotation2d.fromDegrees(120));
        ...
        public static double sideOffset = 0.2;
    }
